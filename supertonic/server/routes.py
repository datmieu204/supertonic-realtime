...
def register_routes(app: FastAPI) -> None:
    ...
    def synth_native(req: TTSRequest, request: Request):
        ...
        except Exception as e:  # noqa: BLE001 - map unexpected synthesis errors to HTTP 500
    ...
    def synth_batch(req: BatchRequest, request: Request):
        ...
        for idx, item in enumerate(req.items):
            ...
            except Exception as e:  # noqa: BLE001 - map unexpected batch errors to HTTP 500
